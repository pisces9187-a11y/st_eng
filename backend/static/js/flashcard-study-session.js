...
const FlashcardStudySession = {
     ...
     * @param {string} reviewMode - Review mode: normal, difficult, due, failed
     * @returns {Promise<Object>} Session data
     */
    async startSession(deckId = null, cardCount = null, reviewMode = 'normal') {
        try {
            console.log(`[FlashcardStudySession] Starting session with mode: ${reviewMode}`);
            ...
            const response = await window.djangoApi.startFlashcardSession(deckId, params.card_count, reviewMode);
