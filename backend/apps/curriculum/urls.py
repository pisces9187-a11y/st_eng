...
page_urlpatterns = [
    ...
    path('pronunciation/error-heatmap/', 
         __import__('apps.curriculum.views_error_heatmap', fromlist=['PronunciationErrorHeatmapView']).PronunciationErrorHeatmapView.as_view(), 
         name='pronunciation-error-heatmap'),
    path('pronunciation/tongue-twister/', 
         __import__('apps.curriculum.views_tongue_twister', fromlist=['TongueTwisterChallengeView']).TongueTwisterChallengeView.as_view(), 
         name='tongue-twister-challenge'),
    path('pronunciation/tongue-twister/submit/', 
         __import__('apps.curriculum.views_tongue_twister', fromlist=['TongueTwisterSubmitView']).TongueTwisterSubmitView.as_view(), 
         name='tongue-twister-submit'),
    path('pronunciation/tongue-twister/leaderboard/', 
         __import__('apps.curriculum.views_tongue_twister', fromlist=['TongueTwisterLeaderboardView']).TongueTwisterLeaderboardView.as_view(), 
         name='tongue-twister-leaderboard'),
    path('pronunciation/phoneme-dashboard/', 
         __import__('apps.curriculum.views_pronunciation', fromlist=['PhonemeDashboardView']).PhonemeDashboardView.as_view(), 
...
urlpatterns = [
    ...
    path('pronunciation/user-progress/', 
    ...
    # =======================================================================
    # PHASE 5.4: PERSONALIZATION & TRACKING API
    # =======================================================================
    
    # Phoneme Progress Tracking
    path('phoneme-progress/<int:phoneme_id>/', 
         __import__('apps.curriculum.api_phase54', fromlist=['PhonemeProgressAPIView']).PhonemeProgressAPIView.as_view(), 
         name='phoneme-progress'),
    
    path('phoneme-progress/<int:phoneme_id>/record-attempt/', 
         __import__('apps.curriculum.api_phase54', fromlist=['PhonemeProgressAPIView']).PhonemeProgressAPIView.as_view(), 
         name='phoneme-record-attempt'),
    
    # Progress Dashboard
    path('phoneme-progress/dashboard/', 
         __import__('apps.curriculum.api_phase54', fromlist=['PhonemeProgressDashboardAPIView']).PhonemeProgressDashboardAPIView.as_view(), 
         name='phoneme-progress-dashboard'),
    
    # Custom Exercise Generation
    path('custom-exercises/', 
         __import__('apps.curriculum.api_phase54', fromlist=['CustomExerciseGeneratorAPIView']).CustomExerciseGeneratorAPIView.as_view(), 
         name='custom-exercises'),
    
    # Progress History (for charts)
    path('progress-history/', 
         __import__('apps.curriculum.api_phase54', fromlist=['ProgressHistoryAPIView']).ProgressHistoryAPIView.as_view(), 
         name='progress-history'),
    
    # Adaptive Difficulty
    path('adaptive-difficulty/<int:phoneme_id>/', 
         __import__('apps.curriculum.api_phase54', fromlist=['AdaptiveDifficultyAPIView']).AdaptiveDifficultyAPIView.as_view(), 
